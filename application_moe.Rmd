...
In general, species likely to be tagged include rainbow trout, bull trout, coho, and burbot. The numbers of fish per stream are likely to be much less than 150 however we are requesting the maximum number of fish to be tagged to allow for flexibility in the field. 

NEED TO UPDATE 
In 2023 the maximum number of fish tagged at one site was less than 100 with a total of 2 burbot tagged.
