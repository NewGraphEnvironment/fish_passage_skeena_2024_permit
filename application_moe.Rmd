...
In general, species likely to be tagged include rainbow trout, bull trout, and burbot. The numbers of fish per stream are likely to be much less than 150 however we are requesting the maximum number of fish to be tagged to allow for flexibility in the field. In 2023 the maximum number of fish tagged at one site was less than 100. 

<!-- In 2023 max was 23 fish caught at one site -->
...
ids <- c(
  ...
  123426,
  #  Lemieux Creek, backwatered. Big outlet pool but dewatering downstream.
  123392,
  ...
  198117,
  198115,
  # Chigaco Creek, potential for baffle installation
  198906,
...
wscodes <- wscodes |>
  dplyr::mutate(wsc_code = case_when(stream_crossing_id == 198217 ~ '400-448500-00000-00000-0000-0000-000-000-000-000-000-000',  T ~ wsc_code))
